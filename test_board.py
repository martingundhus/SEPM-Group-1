...
class TestBoard(unittest.TestCase):
    ...
    def test_stack_on_tile(self):
        self.assertEqual(self.board.getStack(0,0).stack_content, deque(), "Should be an empty stack here")
        self.assertEqual(self.board.getStack(0,1).stack_content, deque(), "Should be an empty stack here")
        self.assertEqual(self.board.getStack(4,3).stack_content, deque(), "Should be an empty stack here")
    ...
    def test_move_stack(self):
        ...
        self.board.moveStack(self.board.current_x, self.board.current_y, 3, 4)
    ...
    def test_move_stack_far(self):
        ...
        self.board.moveStack(self.board.current_x, self.board.current_y, 0, 1)
        self.board.moveStack(self.board.current_x, self.board.current_y, 0, 1)
        self.board.moveStack(self.board.current_x, self.board.current_y, 1, 1)
        self.board.moveStack(self.board.current_x, self.board.current_y, 2, 1)
        self.board.moveStack(self.board.current_x, self.board.current_y, 3, 1)
        self.board.moveStack(self.board.current_x, self.board.current_y, 3, 1)
        self.board.moveStack(self.board.current_x, self.board.current_y, 3, 1)
        self.board.moveStack(self.board.current_x, self.board.current_y, 4, 1)
